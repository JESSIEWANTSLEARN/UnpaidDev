...
function Categories({ data, openModal }) {
  ...
  return (
    <>
      <div className="section-head"><div><h2>Product Categories</h2><p>Derived from WBO_Products.category; there is no separate category table.</p></div><button className="btn-primary" type="button" onClick={() => openModal("categoryInfo")}>+ Add Category</button></div>
